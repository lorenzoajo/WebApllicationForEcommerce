...
<html>
    <head>
        ...
        <title>New Fashion - ordini</title>
        <style type = "text/css">
        html{
            padding: 10px;
            background: #ddd;
    ...
    <body>
        ...
        <div id="container">
            ...
            <table>
                ...
                ResultSet ordini = dbConnection.getOrdini();
                for (ordini.beforeFirst(); ordini.next();) {
                    out.println("<tr><td>"+ordini.getString("codice_ordine")+"</td><td>"+ordini.getString("prezzo_totale")+"</td><td>"
                        +ordini.getString("metodo_di_pagamento")+"</td><td>"+ordini.getString("codice_spedizione")+"</td><td>"+ordini.getString("email")+"</td>"
                        +"<td><a href=\"acquistati.jsp?codice="+ordini.getString("codice_ordine")+"\">prodotti acquistati</a></td>"
                        +"<td id=\"red\"><a href=\"modifica_ordine.jsp?codice="+ordini.getString("codice_ordine")+"\">modifica</a></td></tr>");
                }
                %>
            </table>
        </div>
