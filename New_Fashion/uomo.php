...
<head>
<meta charset="utf-8">
<title>New Fashion - Linea uomo</title>
<link href="css/uomoCSS.css" rel="stylesheet" type="text/css">
</head>
	<?php
	session_start();
...
<body onload="cambia_colori('<?php echo $colore_sfondo; ?>','<?php echo $colore_elementi; ?>')">
  ...
  <div id="container">
  	  <div id="box_link">
      	<div id="link_0" class="link"><a href="prodotto.php?cat=uomo&val=camicie"><b>Camicie</b></a></div>
      	<div id="link_1" class="link"><a href="prodotto.php?cat=uomo&val=maglie"><b>Maglie</b></a></div>
        <div id="link_2" class="link"><a href="prodotto.php?cat=uomo&val=t-shirt"><b>T-shirt</b></a></div>
        <div id="link_3" class="link"><a href="prodotto.php?cat=uomo&val=felpe"><b>Felpe</b></a></div>
        <div id="link_4" class="link"><a href="prodotto.php?cat=uomo&val=pantaloni"><b>Pantaloni</b></a></div>
        <div id="link_5" class="link"><a href="prodotto.php?cat=uomo&val=scarpe"><b>Scarpe</b></a></div>
        <div id="link_6" class="link"><a href="prodotto.php?cat=uomo&val=cappelli"><b>Cappelli</b></a></div>
        <div id="link_7" class="link"><a href="prodotto.php?cat=uomo&val=giacche"><b>Giacche</b></a></div>
      </div>
      <div id="categoria"><strong>Tutti i prodotti: abbigliamento uomo</strong></div>
	  <table>
			<?php
			require("connessione.php");
            $i=0;
            foreach($db->query("SELECT * FROM prodotti WHERE categoria='uomo' ORDER BY codice_prodotto DESC") as $row) {
                if($i%4==0)
                    echo '<tr>';
