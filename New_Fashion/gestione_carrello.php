...
if(isset($_SESSION['email'])) { //se c'è una sessione aperta
	...
	if(isset($_COOKIE['carrello_nf'])) //se è già stato assegnato un codice carrello all'utente
		...
		} while(count==1); //continua a ciclicare finchè trova quell'id carrello nella tabella, quando non lo trova più vuol dire che è ok da suare
		setcookie('carrello_nf', $carrello, time()+(60*60*24)); //1 giorno
