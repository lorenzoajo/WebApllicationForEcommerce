...
<head>
<meta charset="utf-8">
<title>New Fashion - Linea donna</title>
<link href="css/donnaCSS.css" rel="stylesheet" type="text/css">
</head>
	<?php
	session_start();
...
<body onload="cambia_colori('<?php echo $colore_sfondo; ?>','<?php echo $colore_elementi; ?>')">
  ...
  <div id="container">
  	  <div id="box_link">
      	<div id="link_0" class="link"><a href="prodotto.php?cat=donna&val=vestiti"><b>Vestiti</b></a></div>
      	<div id="link_1" class="link"><a href="prodotto.php?cat=donna&val=camicie"><b>Camicie</b></a></div>
        <div id="link_2" class="link"><a href="prodotto.php?cat=donna&val=maglie"><b>Maglie</b></a></div>
        <div id="link_3" class="link"><a href="prodotto.php?cat=donna&val=t-shirt"><b>T-shirt</b></a></div>
        <div id="link_4" class="link"><a href="prodotto.php?cat=donna&val=gonne"><b>Gonne</b></a></div>
        <div id="link_5" class="link"><a href="prodotto.php?cat=donna&val=pantaloni"><b>Pantaloni</b></a></div>
        <div id="link_6" class="link"><a href="prodotto.php?cat=donna&val=cappelli"><b>Cappelli</b></a></div>
        <div id="link_7" class="link"><a href="prodotto.php?cat=donna&val=scarpe"><b>Scarpe</b></a></div>
      </div>
      <div id="categoria"><strong>Tutti i prodotti: abbigliamento donna</strong></div>
	  <table>
			<?php
            $i=0;
            foreach($db->query("SELECT * FROM prodotti WHERE categoria='donna' ORDER BY codice_prodotto DESC") as $row) {
                if($i%4==0)
                    echo '<tr>';
